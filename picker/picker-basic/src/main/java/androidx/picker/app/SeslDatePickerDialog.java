...
public class SeslDatePickerDialog extends AlertDialog
    ...
    final SeslDatePicker mDatePicker;
    ...
    public interface OnDateSetListener {
        void onDateSet(@NonNull SeslDatePicker view, int year, int monthOfYear, int dayOfMonth);
    }
    ...
    public SeslDatePickerDialog(@NonNull Context context,
        ...
        SeslDatePicker.ValidationCallback validationCallback = valid -> {

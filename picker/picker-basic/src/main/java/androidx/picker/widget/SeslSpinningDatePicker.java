...
public class SeslSpinningDatePicker extends LinearLayout
    ...
    TextView mCalendarHeaderText;
    final CalendarPagerAdapter mCalendarPagerAdapter;
    private final LinearLayout mCalendarViewLayout;
    ...
    SeslSpinningDatePickerSpinner mDatePickerSpinner;
    ...
    private final LinearLayout mPickerView;
    ...
    private final View.OnClickListener mCalendarHeaderClickListener = v -> setCurrentViewType(VIEW_TYPE_SPINNER);
    ...
    private final SeslSpinningDatePickerSpinner.OnSpinnerDateClickListener mOnSpinnerDateClickListener
    ...
    public interface OnDateChangedListener {
        void onDateChanged(@NonNull SeslSpinningDatePicker view, int year, int month, int day);
    }
    ...
    public SeslSpinningDatePicker(@NonNull Context context) {
        this(context, null);
    }

    public SeslSpinningDatePicker(@NonNull Context context, @Nullable AttributeSet attrs) {
    ...
    public SeslSpinningDatePicker(@NonNull Context context, @Nullable AttributeSet attrs,
        ...
        switch (mLayoutMode) {
            case LAYOUT_MODE_PHONE:
                inflater.inflate(Build.VERSION.SDK_INT >= 23 ?
                                R.layout.sesl_spinning_date_picker_phone :
                                R.layout.sesl_spinning_date_picker_legacy_phone,
                        this, true);
                break;
            case LAYOUT_MODE_MULTIPANE:
                inflater.inflate(Build.VERSION.SDK_INT >= 23 ?
                                R.layout.sesl_spinning_date_picker_multipane :
                                R.layout.sesl_spinning_date_picker_legacy_multipane,
                        this, true);
                break;
            case LAYOUT_MODE_DEFAULT:
            default:
                inflater.inflate(Build.VERSION.SDK_INT >= 23 ?
                                R.layout.sesl_spinning_date_picker :
                                R.layout.sesl_spinning_date_picker_legacy,
                        this, true);
                break;
        }
        ...
        mCalendarHeaderText =
                mCalendarViewLayout.findViewById(R.id.sesl_date_picker_calendar_header_text);
        ...
        mDatePickerSpinner.setOnValueChangedListener(
                (spinner, oldCalendar, newCalendar, isLeapMonth, lunarDate) -> {
        ...
        mDayOfTheWeekLayout =
                mCalendarViewLayout.findViewById(R.id.sesl_date_picker_day_of_the_week);
        ...
        mCalendarHeaderLayout =
                mCalendarViewLayout.findViewById(R.id.sesl_date_picker_calendar_header_layout);
        if (mIsRTL) {
            mPrevButton =
                    mCalendarViewLayout.findViewById(R.id.sesl_date_picker_calendar_header_next_button);
            mNextButton =
                    mCalendarViewLayout.findViewById(R.id.sesl_date_picker_calendar_header_prev_button);
        ...
        OnTouchListener monthBtnTouchListener = (v, event) -> {
        ...
        mPrevButton.setOnTouchListener(monthBtnTouchListener);
        mNextButton.setOnTouchListener(monthBtnTouchListener);

        OnKeyListener monthBtnKeyListener = (v, keyCode, event) -> {
            if (mIsRTL) {
        ...
        mPrevButton.setOnKeyListener(monthBtnKeyListener);
        mNextButton.setOnKeyListener(monthBtnKeyListener);
        ...
        mFirstBlankSpace =
                mCalendarViewLayout.findViewById(R.id.sesl_date_picker_between_header_and_weekend);
        mFirstBlankSpaceHeight =
                res.getDimensionPixelOffset(R.dimen.sesl_date_picker_gap_between_header_and_weekend);
        mSecondBlankSpace =
                mCalendarViewLayout.findViewById(R.id.sesl_date_picker_between_weekend_and_calender);
    ...
    void clearCalendar(Calendar calendar, int year, int monthOfYear, int dayOfMonth) {
    ...
    public void updateDate(int year, int month, int dayOfMonth) {
        ...
        mTempDate.set(Calendar.DAY_OF_MONTH, Math.min(dayOfMonth, mTempDate.getActualMaximum(Calendar.DAY_OF_MONTH)));
    ...
    private void updateStartEndDateRange(int weekEnd, int year, int monthOfYear, int dayOfMonth) {
        ...
        if (mIsLunar) {
            Calendar lunarToSolarCalendar = convertLunarToSolar(getCalendarForLocale(null,
                    mCurrentLocale), year, monthOfYear, dayOfMonth);
    ...
    public void setMinDate(long minDate) {
        ...
        if (mTempMinMaxDate.get(Calendar.YEAR) != mMinDate.get(Calendar.YEAR)
            ...
            mHandler.postDelayed(() -> updateSimpleMonthView(false), 10);
        }
    }
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        if (mSupportShortSpinnerHeight) {
            ...
            mPickerViewHeight = res.getDimensionPixelOffset(mIsHeightSetForDialog ?
                    R.dimen.sesl_spinning_date_picker_height_dialog :
                    R.dimen.sesl_spinning_date_picker_height);
        }
    ...
    private class CalendarPagerAdapter extends PagerAdapter {
        ...
        @Override
        public void destroyItem(@NonNull View pager, int position, Object view) {
        ...
        switch (mode) {
            case MeasureSpec.AT_MOST:
                if (smallestScreenWidthDp < 600 || mLayoutMode != LAYOUT_MODE_DEFAULT) {
                    mCalendarViewPagerWidth =
                            mViewAnimator.getMeasuredWidth() - (mCalendarViewMargin * 2);
                    mDayOfTheWeekLayoutWidth =
                            mViewAnimator.getMeasuredWidth() - (mCalendarViewMargin * 2);
                } else {
                ...
                while(true) {
                    ...
                    if (var5 >= mNumDays) {
                        while(var6 < mNumDays) {
                            ...
                            String var8 =
                                    mDayFormatter.format(this.mDayLabelCalendar.getTime()).toUpperCase();
                            int var9;
                            if (mIsRTL) {
                            ...
                            c.drawText(var8, (float)(var9 + var5), (float)var2,
    ...
    // TODO rework this method
    // kang
    LunarDate getLunarDateByPosition(int var1) {
        /* var1 = position */
    ...
    public void setGravity(int gravity) {
        LinearLayout.LayoutParams lp =
                (LinearLayout.LayoutParams) mDatePickerSpinner.getLayoutParams();
        lp.gravity = gravity;
    ...
    public void setMargin(int left, int top, int right, int bottom) {
        ViewGroup.MarginLayoutParams lp =
                (ViewGroup.MarginLayoutParams) mDatePickerSpinner.getLayoutParams();
    ...
    public void setHeightForDialog() {
        ...
        mPickerViewHeight =
                getResources().getDimensionPixelOffset(R.dimen.sesl_spinning_date_picker_height_dialog);
        mPickerView.setLayoutParams(new FrameLayout.LayoutParams(
                LayoutParams.MATCH_PARENT, mPickerViewHeight));

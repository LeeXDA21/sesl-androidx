...
class SeslSpinningDatePickerSpinnerDelegate extends SeslSpinningDatePickerSpinner.AbsDatePickerDelegate {
    ...
    final OverScroller mGravityScroller;
    ...
    private final String[] mLongMonths;
    Calendar mMaxValue;
    Calendar mMinValue;
    ...
    private final int mPickerSoundIndex;
    private final int mPickerVibrateIndex;
    ...
    private final float mActivatedAlpha = 0.4f;
    float mAlpha = 0.1f;
    ...
    private final DynamicAnimation.OnAnimationUpdateListener mSpringAnimationUpdateListener = new DynamicAnimation.OnAnimationUpdateListener() {
        @Override
    ...
    private final DynamicAnimation.OnAnimationEndListener mSpringAnimationEndListener = new DynamicAnimation.OnAnimationEndListener() {
        @Override
    ...
    public SeslSpinningDatePickerSpinnerDelegate(SeslSpinningDatePickerSpinner spinningDatePickerSpinner,
        ...
        mFadeOutAnimator.setStartDelay(100L);
        ...
        mColorInAnimator.setDuration(200L);
        ...
        mColorOutAnimator.setDuration(200L);
        mColorOutAnimator.setStartDelay(100L);
    ...
    public void onDraw(Canvas var1) {
        ...
        for(var3 = 0; var3 < var8; ++var3) {
            ...
            float var12 = Math.max(var10, var11);
    ...
    Calendar getWrappedSelectorIndex(Calendar selectorIndex) {
    ...
    // TODO rework this method
    // kang
    String formatDateForLunarForAccessibility(Calendar calendar) {
        String str;
        Calendar calendar2 = (Calendar) calendar.clone();
        SeslSpinningDatePicker.LunarDate lunarDate = new SeslSpinningDatePicker.LunarDate();
        convertSolarToLunar(calendar, lunarDate);
    ...
    String formatDateForAccessibility(Calendar value) {
        if (mFormatter != null) {
            if (mFormatter instanceof SeslSpinningDatePickerSpinner.DateFormatter) {
                return ((SeslSpinningDatePickerSpinner.DateFormatter) mFormatter)
    ...
    class AccessibilityNodeProviderImpl extends AccessibilityNodeProvider {
        ...
        String getVirtualCurrentButtonText() {
            Calendar value = (Calendar) mValue.clone();
            if (mWrapSelectorWheel) {
                value = getWrappedSelectorIndex(value);
            }

...
extra.apply {
    set(
        "moduleInfo", mapOf(
            ...
            "androidx.core" to listOf("1.17.0", "1.0.7-sesl8", "rev2", 21, 36),
            "androidx.core-ktx" to listOf("1.17.0", "1.0.0-sesl8", "rev1", 21, 36),
            "androidx.customview" to listOf("1.2.0-rc01", "1.0.0-sesl8", "rev1", 21, 35),
            "androidx.drawerlayout" to listOf("1.2.0", "1.0.0-sesl8", "rev1", 21, 35),
            "androidx.viewpager" to listOf("1.1.0-beta01", "1.0.0-sesl8", "rev1", 21, 35),
            "androidx.coordinatorlayout" to listOf("1.3.0", "1.0.0-sesl8", "rev1", 21, 35),
            "androidx.appcompat" to listOf("1.7.1", "1.0.21-sesl8", "rev9", 21, 35),
            "androidx.fragment" to listOf("1.8.9", "1.0.5-sesl8", "rev2", 21, 35),
            "androidx.recyclerview" to listOf("1.4.0", "1.0.12-sesl8", "rev4", 21, 35),
            "androidx.preference" to listOf("1.2.1", "1.0.0-sesl8", "rev2", 21, 35),
            ...
            "androidx.picker-basic" to listOf("1.0.7", "1.0.7-sesl8", "rev5", 21, 35),
            "androidx.picker-color" to listOf("1.0.2", "1.0.3-sesl8", "rev3", 21, 35),
            "androidx.picker-app" to listOf("1.0.6", "1.0.6-sesl8", "rev3", 21, 35),
